...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-sm bg-dark">
        ...
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link text-white fs-5" href="{{ route('logout') }}">Logout</a></li>
            </ul>
        </div>
    </nav>
    <!-- /.navbar -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('index') }}" class="brand-link">
            <img src="/img/bkacad.png" alt="HỆ THỐNG ĐIỂM DANH BKACAD" class="brand-image" />
