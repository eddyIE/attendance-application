                        ...
                        <table class="table">
                            @foreach ($list as $each)
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="{{ $each->name }} present" value="1" id="di_hoc">Đi học
                                    </td>
                                    <td>
                                        <input type="radio" name="{{ $each->name }} present" value="no reason" id="no_reason">Nghỉ
                                    </td>
                                    <td>
                                        <input type="radio" name="{{ $each->name }} present" value="late" id="with_reason">Muộn
                                    </td>
                                    <td>
                                        <input type="radio" name="{{ $each->name }} present" value="with reason" id="late">Có phép
                                    </td>
